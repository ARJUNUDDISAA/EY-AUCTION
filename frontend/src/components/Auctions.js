    ...
    <div className="container py-4">
      ...
      <div className="row">
        <div className="col-md-3">
          ...
          <ul className="list-unstyled">
            <li>
              <input type="radio" name="location" onChange={() => setLocationFilter('BMICH Colombo')} checked={locationFilter === 'BMICH Colombo'} /> ANDHRA PRADESH
            </li>
            <li>
              <input type="radio" name="location" onChange={() => setLocationFilter('KCC Kandy')} checked={locationFilter === 'KCC Kandy'} /> HYDERABAD
            </li>
            <li>
              <input type="radio" name="location" onChange={() => setLocationFilter('Negombo')} checked={locationFilter === 'Negombo'} /> BANGLORE
            </li>
          </ul>
