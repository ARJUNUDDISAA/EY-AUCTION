...
const EditPaymentForm = () => {
  ...
  const cardTypes = [
    ...
    },
    {
      name: "Discover",
      imgSrc:
        "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Commons-logo-en.svg/1556px-Commons-logo-en.svg.png",
    },
    {
      name: "JCB",
      imgSrc: "https://www.fintechfutures.com/files/2018/01/JCB-620x400.jpg",
    },
  ];
  ...
  return (
    <div
      style={{
        ...
        minHeight: "100vh",
        backgroundImage:
          "url(https://images.pexels.com/photos/8919543/pexels-photo-8919543.jpeg)",
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="border p-4 rounded shadow">
          ...
          {["fullName", "email", "address", "city", "state", "zipCode"].map(
            (field) => (
