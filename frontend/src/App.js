      ...
      <div className="App">
        <main>
          ...
          <Routes>
            ...
            <Route
              path="/RegisterToAuction/:id"
              element={<RegisterToAuction />}
            />
            <Route
              path="/RegisterToAuction/:id/RegisterToAuctionAsSeller"
              element={<RegisterToAuctionAsSeller />}
            />
            ...
            <Route
              path="/RegisterToAuction/:id/RegisterToAuctionAsBidder"
              element={<RegisterToAuctionAsBidder />}
            />
            ...
            <Route
              path="/JoashPlaceMaharagama"
              element={<JoashPlaceMaharagama />}
            />
            <Route path="/payment" element={<PaymentForm />} />{" "}
            {/* Add Payment Form route */}
            <Route path="/payments" element={<PaymentList />} />{" "}
            {/* Add Payment List route */}
            <Route path="/edit/:id" element={<EditPaymentForm />} />{" "}
            {/* Add Edit Payment Form route */}
          </Routes>
          <Footer />
        </main>
      </div>
